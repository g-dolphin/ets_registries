...
- `ets_registries_data/_raw/euets/eutl_2024_202410/` (contains `compliance.csv`, `installation.csv`, `nace_code.csv`)
- `ets_registries_data/src/registry_processing/euets/aggregate_sector_nace.py`

Run:

```bash
python3 -m registry_processing.euets.aggregate_sector_nace \
